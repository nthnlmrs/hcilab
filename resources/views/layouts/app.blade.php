    ...
    <body class="font-sans antialiased h-full text-museum-darkGreen bg-museum-beige">
        ...
        <div x-data="{ isCollapsed: false }" class="min-h-full flex flex-col md:flex-row bg-[#D8C8AD]/30 relative">
            ...
            <div 
                ...
                <header class="hidden md:flex items-center justify-between bg-white sticky top-0 z-40 px-8 py-4 border-b-2 border-gray-100 shadow-sm">
                        ...
                        @auth
                            ...
                            <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 group">
                                <div class="text-right hidden lg:block">
                                    <p class="text-sm font-bold text-museum-darkGreen leading-none group-hover:text-museum-green transition-colors">{{ Auth::user()->name }}</p>
            ...
            <nav class="md:hidden fixed bottom-0 left-0 w-full bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.1)] rounded-t-[40px] px-6 py-4 flex justify-between items-center z-50">
