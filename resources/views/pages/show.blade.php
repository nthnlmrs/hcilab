                ...
                @elseif($block->type === 'image')
                    <figure class="rounded-3xl overflow-hidden shadow-soft">
                        ...
                        @if(!empty($data['caption']))
                            <figcaption class="p-4 bg-white text-[10px] text-gray-400 text-center italic">{{ $data['caption'] }}</figcaption>
                        @endif
                    </figure>
                    ...
                    <div class="bg-white rounded-3xl overflow-hidden shadow-soft flex flex-col">
                        ...
                        <div class="p-6">
                            ...
                            @if(!empty($data['btn_link']))
                                <a href="{{ $data['btn_link'] }}" class="inline-block px-6 py-2 bg-museum-brown text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-md">
