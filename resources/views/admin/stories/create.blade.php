@section('section_name', 'Add Story Tale')
<x-app-layout>
    <div class="pt-6 pb-20 px-4 max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="font-serif text-xl font-bold text-museum-green">Add Folklore Story</h1>
        </div>
        ...
        <form action="{{ route('admin.stories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm space-y-4 mb-6">
                <div>
                    ...
                    <input type="text" name="title" required class="w-full rounded-xl border-gray-300 focus:border-museum-green focus:ring-museum-green" placeholder="e.g., Cerita Ken Dedes">
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-1">Category</label>
                    <input type="text" name="category" required class="w-full rounded-xl border-gray-300 focus:border-museum-green focus:ring-museum-green" placeholder="e.g., Legend">
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-1">Excerpt</label>
                    <input type="text" name="excerpt" class="w-full rounded-xl border-gray-300 focus:border-museum-green focus:ring-museum-green" placeholder="Brief summary of the story...">
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase mb-1">Full Content</label>
                    <textarea name="content" required rows="6" class="w-full rounded-xl border-gray-300 focus:border-museum-green focus:ring-museum-green" placeholder="Write full story content here..."></textarea>
                </div>
